...
module.exports.makeReview = async (req, res, next) => {
    ...
    const obj = { "text": reviewText, "userId": userObj.id, "userName": userObj.userName,  "reviewer" : userObj.name, "movieId" : movieObj.id, "movieName" : movieObj.title, tmdbId, "timeStamp" : formattedTime, "votes" : 0 }
