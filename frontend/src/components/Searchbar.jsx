...
function Searchbar() {
  ...
  return (
    ...
    //     <input type="text" name='search' placeholder='Search' className='pl-10  py-2 placeholder-gray-500 text-black rounded-full' value={searchResults} onChange={handleSearchChange} />
