...
import { Flex, Button, Grid, Box, Text } from '@radix-ui/themes'
...
import { MagicWandIcon, PersonIcon, BookmarkIcon, FileTextIcon, HeartFilledIcon, EyeClosedIcon, StarIcon, StarFilledIcon } from '@radix-ui/react-icons'
                                ...
                                <div class="relative z-10 grid gap-3 grid-cols-6">
                                    ...
                                    <div class="col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                                        ...
                                        <Flex gap="3" className=' grid grid-cols-2'>
                                            <Button className='bg-custom-30' variant="classic">
                                            ...
                                            <Button className='bg-custom-30' variant="classic">
                                                <EyeClosedIcon width={24} height={24} />Yet to watch

                                            </Button>
                                            <Button className='bg-custom-30' variant="classic">
                                                <StarFilledIcon width={24} height={24} /> Fav

                                            </Button>

                                        </Flex>
                                    </div>
                                    <div class=" col-span-2 overflow-hidden relative p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900 ">
