                            ...
                            <div class="relative">
                                <div class="relative z-10 grid gap-3 grid-cols-6">
                                    ...
                                    <div class="col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                                        ...
                                        <Button onClick={() => navigate(`/${UserID}/Watched`)} className='bg-custom-30 p-7 ' variant="classic">
                                                <FileTextIcon height={32} width={32} />
                                               <Text><Strong>Watched</Strong></Text>
                                            </Button>
                                        <Button onClick={() => navigate(`/${UserID}/rated`)} className='bg-custom-30 p-7 ' variant='classic'  >
                                                <HeartFilledIcon width={24} height={24} />
                                                <Text><Strong>Rated</Strong></Text>
                                            </Button>

                                        <Button onClick={() => navigate(`/${UserID}/yettowatch`)} className='bg-custom-30 p-7 ' variant="classic">
                                            <EyeClosedIcon width={24} height={24} />

                                            <Text><Strong>Yet To Watch</Strong></Text>
                                            </Button>
                                        <Button onClick={() => navigate(`/${UserID}/fav`)} className='bg-custom-30 p-7' variant="classic">
