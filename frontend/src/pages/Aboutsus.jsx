...
function Aboutsus() {
    return (
        <>
        <div className='bg-red-200 p-5 font-mono'>
            <h1 className='text-center text-red-600 ml-2 mr-2 text-5xl italics underline underline-offset-4 mb-4'>ABOUT US</h1>
            <div className='flex ml-10 mr-10 gap-3 justify-between p-3 font-bold text-red-500 underline underline-offset-4'>
                <div className='border bg-amber-300 p-3 border-black rounded-lg '><PiBooksBold size={32} /></div>
                ...
                <div >
                   <button className='p-2 bg-amber-300 rounded-lg border border-black'> ACCOUNT</button>
                </div>
            </div>
            ...
            {/* <div className='flex justify-around text-orange-700'>
                <ul>hello</ul>  
                <ul>hello</ul>  
                <ul>hello</ul>  
            </div> */}
           ...
           <div className=' grid grid-cols-3 gap-3 m-3'>
                ...
                <div className='text-orange-500 italic text-xl   '>
             Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, ratione, cum quisquam tenetur possimus, rerum omnis nisi repellendus quibusdam dignissimos pariatur voluptatem in nobis modi facilis. Modi perferendis repudiandae sint. 
                ...
                <div className='antialiased text-xl text-orange-500 italic '>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque dicta laudantium magnam vel. Velit dolorum molestias pariatur ipsa ex necessitatibus odio alias doloremque, accusamus, natus quibusdam iusto perspiciatis placeat laudantium?  
                ...
                <div className=' text-xl text-orange-500 italic'>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque dicta laudantium magnam vel. Velit dolorum molestias pariatur ipsa ex necessitatibus odio alias doloremque, accusamus, natus quibusdam iusto perspiciatis placeat laudantium?
            </div>
            </div>
